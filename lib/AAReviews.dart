...
class AAReviews extends StatefulWidget {
  const AAReviews({Key? key}) : super(key: key);

  @override
  _AAReviewsState createState() => _AAReviewsState();
}

class _AAReviewsState extends State<AAReviews> {


  CollectionReference AA = FirebaseFirestore.instance.collection("ReviewsAA");
